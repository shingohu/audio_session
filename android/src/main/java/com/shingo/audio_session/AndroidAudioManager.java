    ...
    private static class Singleton {
        ...
        public boolean isLeAudioSupported() {
            if (applicationContext != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                    return adapter != null && adapter.isLeAudioSupported() == BluetoothStatusCodes.FEATURE_SUPPORTED;
                }
            }
            return false;
        }
        ...
        public boolean isLeAudioBroadcastSourceSupported() {
            if (applicationContext != null) {
                ...
                BluetoothAdapter adapter = bluetoothManager.getAdapter();
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                    return adapter != null && adapter.isLeAudioBroadcastSourceSupported() == BluetoothStatusCodes.FEATURE_SUPPORTED;
                }
            }
            return false;
        }
